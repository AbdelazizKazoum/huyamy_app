...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <Link href={`/products/${productSlug}`} className="block">
      <div className="group bg-white rounded-lg shadow-sm border border-neutral-200/60 overflow-hidden flex flex-col h-full transform transition-all duration-300 hover:shadow-xl hover:-translate-y-2 cursor-pointer">
