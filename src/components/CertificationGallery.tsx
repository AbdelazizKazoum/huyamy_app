        ...
        <div className="flex flex-wrap justify-center gap-4 md:gap-6">
          {images.map((imgUrl, index) => (
            <div
              ...
              className="group relative cursor-pointer overflow-hidden rounded-lg border-2 border-gray-200 shadow-sm transition-all duration-300 hover:border-primary-500 hover:shadow-lg"
            >
              <Image
                src={imgUrl}
        ...
        <Dialog as="div" className="relative z-50" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4">
              ...
              >
                <Dialog.Panel className="relative w-full max-w-3xl transform rounded-lg bg-white p-2 shadow-xl transition-all">
                  <button
                    onClick={closeModal}
